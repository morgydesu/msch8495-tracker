...
class MusicTracker {
  ...
  constructor(root) {
    ...
    this.root.querySelector(".tracker__BPM").addEventListener("change", (event) => {
      ...
      const entryList = this.root.querySelector(".entry-list");
      const listItem = entryList.lastElementChild;
      const bpmImageContainer = listItem.querySelector(".tracker__bpm-image");
      bpmImageContainer.innerHTML = "";
      bpmImageContainer.appendChild(imageElement);
    });
  }
    ...
    return `
      <div class="music-tracker">
        <div class="tracker__inputs">
          ...
          <div class="tracker__bpm-image"></div>
          <button class="tracker__add">+</button>
        </div>
      </div>
      <div class="entry-list"></div>
  ...
  updateView() {
    ...
    this.entries.forEach((entry) => {
      ...
      const bpmImageContainer = document.createElement("div");
      bpmImageContainer.classList.add("tracker__bpm-image");
      listItem.appendChild(bpmImageContainer);
