...
class MusicTracker {
  ...
  static rowHtml() {
      return `
          ...
          <td>
                  <input type="id" class="tracker__ID">
                  <span class="tracker__text">Name</span>
              </td>
          <td>
  ...
  updateView() {
      ...
      const addRow = data => {
          ...
          row.querySelector(".tracker__song").value = data.name;
          row.querySelector(".tracker__ID").value = data.name;
