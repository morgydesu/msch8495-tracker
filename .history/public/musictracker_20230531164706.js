      ...
      <div class="music-tracker">
        <div class="tracker__inputs">
          ...
          <select class="tracker__BPM" placeholder="Select speed">
            ...
            <option value="60~90 BPM" data-img_src="./images/low-speed.png">60~90 BPM</option>
            <option value="100~150 BPM" data-img_src="./images/medium-speed.png">100~150 BPM</option>
            <option value="150~180+ BPM" data-img_src="./images/high-speed.png">150~180+ BPM</option>
          </select>
