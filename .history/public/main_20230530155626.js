...
function showAlbumDetails(element) {
  const albumContainer = element.parentNode;
  const albumTitle = albumContainer.querySelector(".album__title").textContent;
  const albumBpm = albumContainer.querySelector(".album__bpm").textContent;
  const albumYear = albumContainer.querySelector(".album__year").textContent;
  ...
  if (popupContainer.style.display === "block") {
    popupContainer.style.display = "none";
    albumTitleElement.style.display = "none";
    albumBpmElement.style.display = "none";
    albumYearElement.style.display = "none";
  } else {
    // Show the album details
    popupContainer.style.display = "block";
    albumTitleElement.style.display = "block";
    albumBpmElement.style.display = "block";
    albumYearElement.style.display = "block";
  }
}
