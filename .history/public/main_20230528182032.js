...
app.appendChild(entryList);
const wt = new MusicTracker(entryList);

const musicTracker = document.createElement("div");
musicTracker.id = "music-tracker";
app.appendChild(musicTracker);
wt.root = musicTracker;
