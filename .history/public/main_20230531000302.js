...
//discover onclick function
// function showAlbumDetails(albumTitle, albumBpm, albumYear, element) {
//   const albumDetailsContainer = element.parentNode.nextElementSibling;
//   const albumTitleElement = albumDetailsContainer.querySelector(".album__title");
//   const albumBpmElement = albumDetailsContainer.querySelector(".album__bpm");
//   const albumYearElement = albumDetailsContainer.querySelector(".album__year");

//   albumTitleElement.textContent = albumTitle;
//   albumBpmElement.textContent = albumBpm;
//   albumYearElement.textContent = albumYear;

//   albumDetailsContainer.style.display = "block";
// }

function showAlbumDetails(albumTitle, albumBpm, albumYear, element) {
  const albumDetailsContainer = element.parentNode.querySelector('.album__details');
  const albumTitleElement = albumDetailsContainer.querySelector('.album__title');
  const albumBpmElement = albumDetailsContainer.querySelector('.album__bpm');
  const albumYearElement = albumDetailsContainer.querySelector('.album__year');
