...
function toggleSidebar() {
  ...
  if (sidebar.style.left === '-250px') {
    ...
    appContent.style.marginLeft = '250px'; // Push the app content to the right
    discoverContent.style.marginLeft = '250px'; // Push the discover content to the right
  } else {
    sidebar.style.left = '-250px';
    sidebarToggle.innerHTML = '&#9776; Open Sidebar';
    appContent.style.marginLeft = '0'; // Reset the app content margin
    discoverContent.style.marginLeft = '0'; // Reset the discover content margin
  }
}
