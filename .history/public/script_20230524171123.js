...
//         row.querySelector(".tracker__song").
//       }}}
...
class MusicTracker {
    ...
    updateView() {
      ...
      const addRow = (data) => {
        ...
        row.querySelector(".tracker__ID").value = data.ID;
        row.querySelector(".tracker__song").Apologies for the incomplete response. Here's the continuation of the modified JavaScript code to include the remaining part inside the sidebar tab:
  ...
  const app = sidebar.querySelector(".tracker__entries");
