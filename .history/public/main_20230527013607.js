...
searchButton.addEventListener('click', function() {
  ...
  // Perform the search operation or any other functionality you desire
  // Example: Display the search term in the console
...
const musicTracker = new MusicTracker(trackerRoot);
