...
function showAlbumDetails(element) {
  ...
  const albumTitle = albumContainer.querySelector(".album__details .album__title").textContent;
  const albumArtist = albumContainer.querySelector(".album__details .album__artist").textContent;
