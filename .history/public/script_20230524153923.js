...
// Inside the constructor of the MusicTracker class
TypeSong = this.root.querySelector(".tracker__song").addEventListener("click", (event) => {
    event.target.value = ""; // Clear the value of the song input field
});
