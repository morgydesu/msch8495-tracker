...
// Export the DescriptionPopup class to the global scope for access in the console
window.DescriptionPopup = DescriptionPopup;
window.pretenderLyrics = pretenderLyrics;
